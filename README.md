...
- Bracket 1 (Rs1,000 - Rs5,000 earnings): **Rs100**
- Bracket 2 (Rs5,000 - Rs10,000 earnings): **Rs200**
- Bracket 3 (Rs10,000+ earnings): **Rs300**
...
- **Base Daily Payout ($Y_{base}$):** The median daily earnings for that specific city (e.g., **Rs500**).
...
- **Time Factor ($T_{pro\_rata}$):** Calculated in 3-hour blocks. If Swiggy/Zomato officially suspends service for just 3 hours during sudden extreme rainfall, the payout is pro-rated (e.g., **0.3x** of the daily rate) to cover that specific lost window.
...
- Rahul is a full-time Swiggy partner in Chennai making about **Rs6,000 a week**.
...
- He pays exactly **Rs270 a week** -> less than a tank of petrol -> deducted automatically from his wallet.
...
- Using the daily city average (**Rs500**) and a Red Alert multiplier (**1.5x**), the system automatically triggers a **Rs750 payout**.
...
## 7. NewsPulse AI FastAPI Service
