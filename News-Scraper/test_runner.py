...
from news_scraper_api.services.news_service import format_articles_for_analysis
...
def run_test(city_name: str, file_handle):
    ...
    formatted_text = format_articles_for_analysis(articles)
    ...
    file_handle.write(f"**Disruption Detected**: `{result.disruption_found}`\n\n")
    file_handle.write(f"**AI Reasoning**: {result.reasoning}\n\n")
